...
public partial class Artists : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //artist = (string)Session["ThisArtist"];
        //if (artist == null)
        //    artist = "";
        //if (!Page.IsPostBack)
        ItemsGet("");
    ...
    {
        if (ArtistSortDDL.SelectedValue == "Large")
        {
            EnterArtistLBL.Text = "";
        ...
        else if (ArtistSortDDL.SelectedValue == "Small")
        {
            Response.Redirect("~/ArtistsSmall.aspx");
        }
        return null;
    }
    ...
    {
        ArtistSortDDL.SelectedValue = "Large";
        if (ArtistPageDDL.SelectedValue == "All")
        {
            pageSize = artistNum;
        }
    ...
    {
        Image background = (Image)e.Item.FindControl("LargeMinBG");
        ...
        Label JoinedLBL = (Label)e.Item.FindControl("dateJoinedLBL");
        Label SubmissionLBL = (Label)e.Item.FindControl("SubmissionLBL");
        //Button DetailsCloseBTN = (Button)e.Item.FindControl("DetailsCloseBTN");
        //Button DetailsCloseBTN = (Button)e.Item.FindControl("button_0");
        //Button seeAllBTN = (Button)e.Item.FindControl("seeAllBTN");
        ...
        if (e.CommandName == "ExpandsOrCloses")
        {
            for (int i = 0; i < artistNum; i++)
            {
                ...
                {
                    background.ImageUrl = "~/App_Themes/Green/images/light_blue_big.png";

                    // Move the minimal pieces up
                    artistAvatar.Attributes.Add("style", "bottom:247px;");
                    artistNameBG.Attributes.Add("style", "bottom:302px;");
                    artistNameLBL.Attributes.Add("style", "bottom:309px;");
                    JoinedLBL.Attributes.Add("style", "bottom:309px;");
                    artistDetailsBG.Attributes.Add("style", "bottom:254px;");
                    SubmissionLBL.Attributes.Add("style", "bottom:260px;");
                    DetailsCloseBTN.Attributes.Add("style", "bottom:257px;");
                    SubmissionLBL.Visible = false;
                ...
                {
                    // Move the minimal pieces back down
                    background.ImageUrl = "~/App_Themes/Green/images/light_blue_med.png";
                    artistAvatar.Attributes.Add("style", "bottom:130px;");
                    artistNameBG.Attributes.Add("style", "bottom:185px;");
                    artistNameLBL.Attributes.Add("style", "bottom:192px;");
                    JoinedLBL.Attributes.Add("style", "bottom:192px;");
                    artistDetailsBG.Attributes.Add("style", "bottom:137px;");
                    SubmissionLBL.Attributes.Add("style", "bottom:144px;");
                    DetailsCloseBTN.Attributes.Add("style", "bottom:140px;");
                    SubmissionLBL.Visible = true;
